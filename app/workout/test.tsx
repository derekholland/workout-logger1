...
import { Card, CardHeader, CardTitle, CardContent, CardFooter } from 'shadcn-ui';
...
const WorkoutForm = () => {
  ...
  const exerciseOptions = ['Squat', 'Bench Press', 'Deadlift', 'Overhead Press']; // Example exercise options
    ...
    <Card className="max-w-lg mx-auto mt-10 bg-white dark:bg-gray-800 shadow-md rounded-lg">
      ...
      <CardContent>
        <form onSubmit={handleSubmit}>
          {/* Workout Title */}
          <div className="mb-4">
            <Label htmlFor="workoutTitle" className="block text-gray-800 dark:text-gray-300">
              Workout Title
            </Label>
            <Input
              id="workoutTitle"
          ...
          {/* Exercise Dropdown */}
          <div className="mb-4">
            <Label htmlFor="exercise" className="block text-gray-800 dark:text-gray-300">
              Select Exercise
            </Label>
            <select
              id="exercise"
          ...
          <div className="mb-4">
            <Label htmlFor="workingWeight" className="block text-gray-800 dark:text-gray-300">
              Working Weight (lbs)
            </Label>
            <Input
              id="workingWeight"
            ...
            <div className="mb-4">
              ...
              {sets.map((set, index) => (
                <div key={index} className="flex space-x-4 mb-2">
                  <div>
                    <Label htmlFor={`reps-${index}`} className="block text-gray-800 dark:text-gray-300">
                      Reps
                    </Label>
                    <Input
                      id={`reps-${index}`}
                  ...
                  <div>
                    <Label htmlFor={`weight-${index}`} className="block text-gray-800 dark:text-gray-300">
                      Weight (lbs)
                    </Label>
                    <Input
                      id={`weight-${index}`}
